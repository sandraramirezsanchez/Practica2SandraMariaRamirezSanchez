    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bteditar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent editardatos = new Intent(MainActivity2.this, MainActivity.class);
                editardatos.putExtra("nombre", tv1.getText().toString());
                editardatos.putExtra("telefono", tv2.getText().toString());
